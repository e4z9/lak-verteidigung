...
(function(exports) {
  ...
  var toEOL1 = Data_Function.apply(some)(Text_Parsing_Parser_String.noneOf(Data_Identity.monadIdentity)([ "\n" ]));
  var many = function (c) {
  ...
  var spaces = Data_Function.apply(many)(Text_Parsing_Parser_String.oneOf(Data_Identity.monadIdentity)([ " ", "\t", "\r", "\n" ]));
  ...
  var positiveInt = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(some(digit))(function (v) {
      ...
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_MonadZero.guard(Text_Parsing_Parser.monadZeroParserT(Data_Identity.monadIdentity))(Data_Maybe.isJust(i)))(function () {
          return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity)))(Data_Maybe.fromMaybe(0)(i));
      });
  });
  ...
  var fromString = function (s) {
      return Data_Function.apply(Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create))(Text_Parsing_Parser.runParser(s)(attack));
  };
